Feature: Book a room in a hotel
  ...
  Scenario: A helpful user, using weekend
     Given I'm a user with the following persona:
      ...
      Then The assistant should fetch the current date
       And The assistant should book a room for Pedro Sousa, in the hotel with id 34, starting in 2024-02-09 and ending in 2024-02-11, for 3 people
       And The conversation should make sense, with a score above 8
  ...
  Scenario: A helpful user, using relative day
     Given I'm a user with the following persona:
      ...
      Then The assistant should fetch the current date
       And The assistant should book a room for Pedro Sousa, in the hotel with id 34, starting in 2024-01-25 and ending in 2024-01-28, for 2 people
       And The conversation should make sense, with a score above 8
